  ...
  <MainLayout>
    <div id="itemPage" class="mt-4 max-w-[1200px] mx-auto px-2">
      <div class="md:flex gap-4 justify-between mx-auto w-full">
        <div class="md:w-[40%]">
          <img :src="currentImage" class="rounded-lg object-contain" />
        ...
        <div class="md:w-[60%] bg-white p-3 rounded-lg">
          <div v-if="true">
            <p class="mb-2">Ini Judul Barang</p>
            <p class="font-light text-[12px] mb-2">Ini deskripsi barang</p>
          </div>
          ...
          <div class="flex items-center justify-start gap-2 my-2">
            <div class="text-xl font-bold">Rp 123.000,00</div>
...
let currentImage = ref("https://images.unsplash.com/photo-1496181133206-80ce9b88a853?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2671&q=80");
// onMounted(() => {
//   watchEffect(() => {
